...
python -m pip install --upgrade https://github.com/googlesamples/assistant-sdk-python/releases/download/0.5.0/google_assistant_library-1.0.0-py2.py3-none-linux_armv7l.whl
